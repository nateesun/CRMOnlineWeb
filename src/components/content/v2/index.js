                    ...
                    <ul className="contacts-list">
                      ...
                      <li>
                        <a href="/#">
                          <img
                            className="contacts-list-img"
                            src="dist/img/user7-128x128.jpg" alt=""
                          />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Sarah Doe
                      ...
                      <li>
                        <a href="/#">
                          <img
                            className="contacts-list-img"
                            src="dist/img/user3-128x128.jpg" alt=""
                          />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Nadia Jolie
                      ...
                      <li>
                        <a href="/#">
                          <img
                            className="contacts-list-img"
                            src="dist/img/user5-128x128.jpg" alt=""
                          />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Nora S. Vans
                      ...
                      <li>
                        <a href="/#">
                          <img
                            className="contacts-list-img"
                            src="dist/img/user6-128x128.jpg" alt=""
                          />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              John K.
                      ...
                      <li>
                        <a href="/#">
                          <img
                            className="contacts-list-img"
                            src="dist/img/user8-128x128.jpg" alt=""
                          />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Kenneth M.
              ...
              <div className="card">
                ...
                <div className="card-body p-0">
                  <ul className="users-list clearfix">
                    <li>
                      <img src="dist/img/user1-128x128.jpg" alt="User Images" />
                    ...
                    <li>
                      <img src="dist/img/user8-128x128.jpg" alt="User Images" />
                      <a className="users-list-name" href="/#">
                        Norman
                      </a>
                    ...
                    <li>
                      <img src="dist/img/user7-128x128.jpg" alt="User Images" />
                      <a className="users-list-name" href="/#">
                        Jane
                      </a>
                    ...
                    <li>
                      <img src="dist/img/user6-128x128.jpg" alt="User Images" />
                      <a className="users-list-name" href="/#">
                        John
                      </a>
                      <span className="users-list-date">12 Jan</span>
                    ...
                    <li>
                      <img src="dist/img/user2-160x160.jpg" alt="User Images" />
                      <a className="users-list-name" href="/#">
                        Alexander
                      </a>
                    ...
                    <li>
                      <img src="dist/img/user5-128x128.jpg" alt="User Images" />
                      <a className="users-list-name" href="/#">
                        Sarah
                      </a>
                    ...
                    <li>
                      <img src="dist/img/user4-128x128.jpg" alt="User Images" />
                      <a className="users-list-name" href="/#">
                        Nora
                      </a>
                    ...
                    <li>
                      <img src="dist/img/user3-128x128.jpg" alt="User Images" />
                      <a className="users-list-name" href="/#">
                        Nadia
                      </a>
                      <span className="users-list-date">15 Jan</span>
