/*
 * ProfileEdit Messages
 *
 * This contains all the text for the ProfileEdit container.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.containers.ProfileEdit';

export default defineMessages({
  header: {
    id: `${scope}.header`,
    defaultMessage: 'This is the ProfileEdit container!',
  },
  enterEmail: {
    id: `${scope}.enterEmail`,
