...
describe('trackOrdersReducer', () => {
  ...
  it('should handle the initState action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.initState())).toEqual(expectedResult);
  });
  it('should handle the changePage action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.changePage('page'))).toEqual(expectedResult);
  });
  it('should handle the initLoad action correctly', () => {
    const expectedResult = produce(state, () => {});
    expect(trackOrdersReducer(state, actions.initLoad('page'))).toEqual(expectedResult);
  });
  it('should handle the initLoadSuccess action correctly', () => {
    const expectedResult = produce(state, draft => {
      draft.list = [];
    });
    expect(trackOrdersReducer(state, actions.initLoadSuccess([]))).toEqual(expectedResult);
  });
  it('should handle the initLoadError action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.initLoadError())).toEqual(expectedResult);
  });
  it('should handle the loadEdit action correctly', () => {
    const expectedResult = produce(state, draft => {
      draft.data = 'data';
    });
    expect(trackOrdersReducer(state, actions.loadEdit('data'))).toEqual(expectedResult);
  });
  it('should handle the loadEditSuccess action correctly', () => {
    const expectedResult = produce(state, draft => {
      draft.list = [];
    });
    expect(trackOrdersReducer(state, actions.loadEditSuccess([]))).toEqual(expectedResult);
  });
  it('should handle the loadEditError action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.loadEditError())).toEqual(expectedResult);
  });
  ...
  //   });
  //   expect(trackOrdersReducer(state, actions.createItem('data'))).toEqual(expectedResult);
  // });
  it('should handle the createItemSuccess action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.createItemSuccess())).toEqual(expectedResult);
  });
  it('should handle the createItemError action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.createItemError())).toEqual(expectedResult);
  });
  it('should handle the updateItem action correctly', () => {
    const expectedResult = produce(state, draft => {
      draft.data = 'data';
    });
    expect(trackOrdersReducer(state, actions.updateItem('data'))).toEqual(expectedResult);
  });
  it('should handle the updateItemSuccess action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.updateItemSuccess())).toEqual(expectedResult);
  });
  it('should handle the updateItemError action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.updateItemError())).toEqual(expectedResult);
  });
  it('should handle the deleteItem action correctly', () => {
    const expectedResult = produce(state, draft => {
      draft.data.uuid_index = 'uuid_index';
    });
    expect(trackOrdersReducer(state, actions.deleteItem('uuid_index'))).toEqual(expectedResult);
  });
  it('should handle the deleteItemSuccess action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.deleteItemSuccess())).toEqual(expectedResult);
  });
  it('should handle the deleteItemError action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.deleteItemError())).toEqual(expectedResult);
  });
  it('should handle the search action correctly', () => {
    const expectedResult = produce(state, () => {});
    expect(trackOrdersReducer(state, actions.search('email'))).toEqual(expectedResult);
  });
  it('should handle the searchSuccess action correctly', () => {
    const expectedResult = produce(state, draft => {
      draft.list = [];
    });
    expect(trackOrdersReducer(state, actions.searchSuccess([]))).toEqual(expectedResult);
  });
  it('should handle the searchError action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.searchError())).toEqual(expectedResult);
  });
  it('should handle the loadView action correctly', () => {
    const expectedResult = produce(state, draft => {
      draft.data = 'data';
    });
    expect(trackOrdersReducer(state, actions.loadView('data'))).toEqual(expectedResult);
  });
  it('should handle the loadViewSuccess action correctly', () => {
    const expectedResult = produce(state, draft => {
      draft.list = [];
    });
    expect(trackOrdersReducer(state, actions.loadViewSuccess([]))).toEqual(expectedResult);
  });
  it('should handle the loadViewError action correctly', () => {
    ...
    expect(trackOrdersReducer(state, actions.loadViewError())).toEqual(expectedResult);
  });
});
