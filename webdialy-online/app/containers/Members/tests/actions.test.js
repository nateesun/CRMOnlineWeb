...
describe('Members actions', () => {
  ...
  describe('loadRoles Action', () => {
    it('has a type of LOAD_ROLES', () => {
      const expected = {
        type: constants.LOAD_ROLES,
      };
      expect(actions.loadRoles()).toEqual(expected);
    });
  });
  describe('loadRolesSuccess Action', () => {
    it('has a type of LOAD_ROLES_SUCCESS', () => {
      const expected = {
        type: constants.LOAD_ROLES_SUCCESS,
        payload: 'success',
      };
      expect(actions.loadRolesSuccess('success')).toEqual(expected);
    });
  });
  describe('loadRolesError Action', () => {
    it('has a type of LOAD_ROLES_ERROR', () => {
      const expected = {
        type: constants.LOAD_ROLES_ERROR,
        payload: 'error',
      };
      expect(actions.loadRolesError('error')).toEqual(expected);
    });
  });
});
