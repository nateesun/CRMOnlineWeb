...
export const UPDATE_PASSWORD_ERROR =
  'containers/ProfileChangePwd/UPDATE_PASSWORD_ERROR';
export const INIT_LOAD = 'containers/ProfileChangePwd/INIT_LOAD';
export const INIT_LOAD_SUCCESS =
  'containers/ProfileChangePwd/INIT_LOAD_SUCCESS';
export const INIT_LOAD_ERROR = 'containers/ProfileChangePwd/INIT_LOAD_ERROR';
