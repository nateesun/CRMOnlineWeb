/*
 * DatabaseConfig Messages
 *
 * This contains all the text for the DatabaseConfig container.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.containers.DatabaseConfig';

export default defineMessages({
  header: {
    id: `${scope}.header`,
    defaultMessage: 'This is the DatabaseConfig container!',
  },
  newItemHeader: {
