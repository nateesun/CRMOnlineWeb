...
import messagesProfile from './messages';
    ...
    <Container component="main" maxWidth="lg">
      <div className={classes.paper}>
        ...
        <Typography variant="h5" className={classes.loginTopic}>
          <FormattedMessage {...messagesProfile.headerEditForm} />
        </Typography>
        <form className={classes.form} onSubmit={handleSubmit(onValidated)}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <Field
                ...
                type="text"
                margin="normal"
                label={<FormattedMessage {...messagesProfile.code} />}
                disabled={true}
              />
            </Grid>
            <Grid item xs={12} md={6}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={6} lg={3}>
              ...
              >
                <FormattedMessage {...messagesProfile.btnSaveProfile} />
              </Button>
            </Grid>
            <Grid item xs={6} lg={3}>
              <Button
                ...
                onClick={reset}
              >
                <FormattedMessage {...messagesProfile.btnResetForm} />
              </Button>
            </Grid>
          </Grid>
        </form>
...
export default connect((state, props) => ({
  initialValues: {
    ...props.profile,
    dateOfBirth: props.profile.brithday.substr(0, 10),
  },
