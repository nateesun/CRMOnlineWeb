/*
 * UsePromotion Messages
 *
 * This contains all the text for the UsePromotion container.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.containers.UsePromotion';

export default defineMessages({
  header: {
    id: `${scope}.header`,
    defaultMessage: 'This is the UsePromotion container!',
  },
  newItemHeader: {
